...
const {
    ...
    deleteQuizQuestions,
    sortNewestModule
} = require('../old-controller/coursesController.js');
...
// all old-routes to create new data on the learning modules database
...
//all old-routes to update existing data on the learning modules database
...
//all old-routes to delete existing data on the learning modules database
